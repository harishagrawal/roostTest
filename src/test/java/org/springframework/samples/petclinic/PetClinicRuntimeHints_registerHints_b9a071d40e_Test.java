...
public class PetClinicRuntimeHints_registerHints_b9a071d40e_Test {
    ...
    public void testRegisterHints() {
        ...
        when(hints.resources()).thenReturn(hints.resources());
        when(hints.serialization()).thenReturn(hints.serialization());
        
        petClinicRuntimeHints.registerHints(hints, Thread.currentThread().getContextClassLoader());
